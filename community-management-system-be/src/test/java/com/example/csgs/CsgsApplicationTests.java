...
//        Journal journal = new Journal(2,"虎跃龙门","movie","成龙", new Date());
...
//
//        Journal journal = new Journal(1,"虎跃龙门","movie","成龙", new Date());
...
////        TermQueryBuilder termQueryBuilder = QueryBuilders.termQuery("title_name", "风急天高猿啸哀");//精确查询
//        MultiMatchQueryBuilder termQueryBuilder = QueryBuilders.multiMatchQuery("的","title_name","content");//多个字段里找text
